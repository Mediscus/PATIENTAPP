...
var Field = function Field(props) {
  ...
  if (label) {
    ...
    oLabel = /*#__PURE__*/React.createElement(SemanticUI, {
      atom: "label",
      key: "label",
      htmlFor: props.id,
  ...
  if (isGroup) {
    ...
    input = inputComponent ? inputComponent : _SemanticUI || (_SemanticUI = /*#__PURE__*/React.createElement(SemanticUI, null));
    ...
    input = /*#__PURE__*/cloneElement(input, _objectSpread(_objectSpread({}, others), {}, {
  ...
  if (topTip) {
    topTipEl = /*#__PURE__*/React.createElement(Label, {
      key: "topTip",
  ...
  if (inputWrapper) {
    inputs = /*#__PURE__*/cloneElement(inputWrapper, inputWrapperAttr, inputs);
  }
  ...
  if (message) {
    messageEl = /*#__PURE__*/React.createElement(Message, _extends({
      messageType: messageType
    }, thisMessageProps), message);
  }

  if (bottomTip) {
    bottomTipEl = /*#__PURE__*/React.createElement(Label, {
      className: "above pointing prompt"
    }, bottomTip);
  }

  if (rightTip) {
    rightTipEl = /*#__PURE__*/React.createElement(Label, {
  ...
  return /*#__PURE__*/React.createElement(SemanticUI, _extends({}, fieldProps, {
    className: classes,
