...
const timelineData = [
  {
    ...
    data: {
      ...
      comment:
        "I am suffering from fever since 2 weeks, some time fever goes high near 105 with cold, body pain. I am taking Dolo 650 mg since 2 days, but did not get relief yet. Please let me know what medicine should I take.",
      reports: [
        {
          id: 1,
          name: "Blood Report",
  ...
  //       {
  //         id: 12001,
  //         name: "Familial Hypercholesterolemia (heterozygote)",
  //         start_date: "28/09/2022",
  //         year: "2022",
  //         status: "Chronic",
  //       },
  ...
  //             data: [
  //               "Hemoptysis , and swollen legs : Present",
  //               "Hemoptysis , and swollen legs : Present",
  //             ],
  //           },
  //         ],
  ...
  //         data: [
  //           { key: "Pulse", value: "72" },
  //           { key: "Blood Pressure", value: "70/120" },
  //           { key: "Respiratory Rate", value: "70/120" },
  //           { key: "Oxygen Saturation SPO2", value: "70:120" },
  //           { key: "Temperature", value: "100" },
  //         ],
  //       },
  //       {
  ...
  //     ],
  //     investigations: [
  //       { id: 1000, name: "CBC Blood test auto 500mg" },
  //       { id: 1002, name: "CHEST X RAY" },
  //       ,
  //       { id: 1003, name: "URINE R/M" },
  //     ],
  //     advice_comment: [
  //       { name: "Diet", data: [] },
  //       { name: "Exercise", data: [] },
  ...
  //     ],
  //     follow_up: {
  //       next_visit: "12/12/2022",
  //       regular_visit: "In every 25 Days",
  //       message: "This is a testing follow up message for patient.",
  //     },
  //     referral: {
  //       doctor_name: "Dr Jay Prakash",
  //       speciality: "General Physician",
  //       comment: "This is extra comment for doctor and patient.",
  //       priority: "Urgent",
  //     },
  //   },
  // },
  ...
  //   data: {
  //     patient_admission: [
  //       "Admit patient under perticular specialist in the ward / icu after reseving bed",
  //     ],
  //     patient_discharge: ["Discharge patient as advised by consultant Doctor"],
  //     doctors_notes: ["RMO Charting", "Testing doctor notes"],
  //     patient_complaints: [
  //       "C/O Pain inn abdomen increased as compared to morning",
  //     ],
  ...
  //     ],
  //     follow_patient_activity: [
  //       "Bowel motions and comment",
  //       "Urinary frequency and quantity",
  //     ],
  //     add_report_manually: [
  //       {
  //         id: 1,
  ...
  //       "C/O Pain inn abdomen increased as compared to morning",
  //     ],
  //     follow_treatment_chart: [
  //       "Tab  Dolo  650 mg  1-0-1  5 Days",
  //       "Cap  Lanol  650 mg  1-0-1  5 Days",
  //     ],
  //     send_investigation: [
  //       "Blood sample send to pathology",
  //       "The urine sample sent to pathology",
  //     ],
  //     initial_assessment: [
  //       {
  //         category_name: "General Examination",
  ...
  //       "Mid-Meal (11:00-11:30AM) green gram sprouts 1 cup",
  //     ],
  //     follow_patient_exercise: [
  //       "High-intensity interval training (HIIT)",
  //       "Bicycle or elliptical machine",
  //       "Walking. Walking is one of the easiest aerobic exercises to do, and you don't need any equipment — just your two feet.",
  //     ],
  //     follow_patient_activity: [
  //       "Bowel motions and comment",
  //       "Urinary frequency and quantity",
  ...
  //   data: {
  //     sample_request: [
  //       "The Laxmi pathology center has requested blood sample",
  //       "The Laxmi pathology center has requested urine sample",
  //     ],
  //     reports: [
  //       {
  //         id: 1,
