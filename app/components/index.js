...
export Tab from "./Panel/Tab";
export { TabPanel } from "./Panel/TabPanel";
export { a11yProps } from "./Panel/TabPanel";

//Widgets
export MessageList from "./Widgets/MessageList";
export CounterIconsWidget from "./Widgets/CounterIconsWidget";
export PerformanceChartWidget from "./Widgets/PerformanceChartWidget";
export FirstClinicWidget from "./Widgets/FirstClinicWidget";
export SecondClinicWidget from "./Widgets/SecondClinicWidget";
export ThirdClinicWidget from "./Widgets/ThirdClinicWidget";
