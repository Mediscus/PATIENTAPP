    ...
    return (
        <Box sx={{ display: "flex", alignItems: "center" }}>
            <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                />
                <Typography variant="h6">{patientDetails.first_name + ' ' + patientDetails.last_name}</Typography>
            </Box>
            ...
            <Divider className={classes.dividerVertical} orientation="vertical" />
            <Typography variant="body2">{patientDetails.dial_country_code + ' ' + patientDetails.phone}</Typography>
        </Box>
    )
}
